...
#define SHARK_SIZE_SMALL 0.5
#define SHARK_SIZE_NORMAL 0.7
#define SHARK_SIZE_BIG 0.9
...
#define SHARK_SPEED_SMALL 1
#define SHARK_SPEED_NORMAL 0.75
#define SHARK_SPEED_BIG 0.5
